...
def process_list(eff_list, vdet_list, filename):
    ...
    plt.ylabel('Fraction of problems with GBS-I advantage', fontsize=20)
    plt.ylim(-0.05, 1.1)
    ...
    for i, N in enumerate(N_values):
        ...
        for j, K in enumerate(K_values):
            ...
            try:
                ...
                filename = f'/work/GBSPE/exp/hafsq/fig/{exp_id}.png'
...
def main():
    ...
    plt.tick_params(axis='both', which='minor', labelsize=12)  # Adjust minor tick size
    plt.tight_layout()
    plt.savefig('/work/GBSPE/exp/hafsq/fig/ratio_count.png')
    ...
    plt.tick_params(axis='both', which='minor', labelsize=12)  # Adjust minor tick size
    plt.tight_layout()
    plt.savefig('/work/GBSPE/exp/hafsq/fig/ratio_weight.png')
